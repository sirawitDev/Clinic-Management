  ...
  try {
    switch (method) {
      case 'POST':
        ...
        return await prisma.infoDiagnosis.create({
          data: {
            ...body,
          },
        });
      ...
      case 'PUT':
        ...
        return await prisma.infoDiagnosis.update({
          where: { id },
          data: updateData,
        });
      ...
      case 'DELETE': {
        ...
        await prisma.infoDiagnosis.delete({ where: { id: Number(id) } });
        return { success: true };
      }

      case 'GET':
        return await prisma.infoDiagnosis.findMany();
